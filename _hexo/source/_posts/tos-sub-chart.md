...
- マップは [TOSCAMP](http://toscamp.com/map/map4.1.php) が便利だよ。
...
□ 事前準備 (チーム倉庫)
	...
	□ ID、ミッション用に経験値UP書
□ オルシャ側でキャラクター作成
□ オルシャ側からスタート (R6まではメインクエ中心でやればOK)
	□ lv1 レンパリサ池
		□ ジェミナ像 (ジェミナ像祈りクエついでに)
		□ ヴァカリネ像
...
□ 王陵1Fから再開
	□ 王陵 (5Maps)
		□ ジャカリエルバングルが欲しければサブクエ消化(買うほうが早い)
		□ 王陵メインクエクリアでステータス+3
		□ lv81 王陵1階
			□ ヴァカリネ像
		□ lv84 王陵2階
